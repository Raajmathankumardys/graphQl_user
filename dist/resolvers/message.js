...
exports.messageResolvers = {
    Subscription: {
        messageAdded: {
            ...
            resolve: (payload) => {
                ...
                return (payload === null || payload === void 0 ? void 0 : payload.messageAdded) || null;
            },
        },
    },
    Mutation: {
        sendMessage: async (_, { userId, channelId, content }, context) => {
    ...
    Query: {
        getMessagesByChannel: (_, { channelId }, { messageService }) => messageService.getMessagesByChannel(channelId),
    },
};
